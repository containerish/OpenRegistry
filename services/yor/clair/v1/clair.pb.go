...
var file_services_yor_clair_v1_clair_proto_rawDesc = []byte{
	...
	0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5a, 0x0a,
...
func file_services_yor_clair_v1_clair_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_yor_clair_v1_clair_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnableVulnerabilityScanningRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_yor_clair_v1_clair_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnableVulnerabilityScanningResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_yor_clair_v1_clair_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClairIndexManifestRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_yor_clair_v1_clair_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_yor_clair_v1_clair_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_yor_clair_v1_clair_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
