...
const (
	...
	GitHubActionsLogsServiceName = "services.kone.github_actions.v1.GitHubActionsLogsService"
)

// GitHubActionsLogsServiceClient is a client for the
// services.kone.github_actions.v1.GitHubActionsLogsService service.
...
// services.kone.github_actions.v1.GitHubActionsLogsService service. By default, it uses the Connect
...
func NewGitHubActionsLogsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GitHubActionsLogsServiceClient {
	...
	return &gitHubActionsLogsServiceClient{
		streamWorkflowJobLogs: connect_go.NewClient[v1.StreamWorkflowJobLogsRequest, v1.StreamWorkflowJobLogsResponse](
			httpClient,
			baseURL+"/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowJobLogs",
			opts...,
		),
		streamWorkflowRunLogs: connect_go.NewClient[v1.StreamWorkflowRunLogsRequest, v1.StreamWorkflowRunLogsResponse](
			httpClient,
			baseURL+"/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowRunLogs",
			opts...,
		),
		dumpLogs: connect_go.NewClient[v1.DumpLogsRequest, v1.DumpLogsResponse](
			httpClient,
			baseURL+"/services.kone.github_actions.v1.GitHubActionsLogsService/DumpLogs",
			opts...,
		),
	}
}
...
// services.kone.github_actions.v1.GitHubActionsLogsService.StreamWorkflowJobLogs.
...
// services.kone.github_actions.v1.GitHubActionsLogsService.StreamWorkflowRunLogs.
...
// DumpLogs calls services.kone.github_actions.v1.GitHubActionsLogsService.DumpLogs.
...
func NewGitHubActionsLogsServiceHandler(svc GitHubActionsLogsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowJobLogs", connect_go.NewServerStreamHandler(
		"/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowJobLogs",
		svc.StreamWorkflowJobLogs,
		opts...,
	))
	mux.Handle("/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowRunLogs", connect_go.NewServerStreamHandler(
		"/services.kone.github_actions.v1.GitHubActionsLogsService/StreamWorkflowRunLogs",
		svc.StreamWorkflowRunLogs,
		opts...,
	))
	mux.Handle("/services.kone.github_actions.v1.GitHubActionsLogsService/DumpLogs", connect_go.NewUnaryHandler(
		"/services.kone.github_actions.v1.GitHubActionsLogsService/DumpLogs",
		svc.DumpLogs,
		opts...,
	))
	return "/services.kone.github_actions.v1.GitHubActionsLogsService/", mux
}
...
func (UnimplementedGitHubActionsLogsServiceHandler) StreamWorkflowJobLogs(context.Context, *connect_go.Request[v1.StreamWorkflowJobLogsRequest], *connect_go.ServerStream[v1.StreamWorkflowJobLogsResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("services.kone.github_actions.v1.GitHubActionsLogsService.StreamWorkflowJobLogs is not implemented"))
}
...
func (UnimplementedGitHubActionsLogsServiceHandler) StreamWorkflowRunLogs(context.Context, *connect_go.Request[v1.StreamWorkflowRunLogsRequest], *connect_go.ServerStream[v1.StreamWorkflowRunLogsResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("services.kone.github_actions.v1.GitHubActionsLogsService.StreamWorkflowRunLogs is not implemented"))
}
...
func (UnimplementedGitHubActionsLogsServiceHandler) DumpLogs(context.Context, *connect_go.Request[v1.DumpLogsRequest]) (*connect_go.Response[v1.DumpLogsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("services.kone.github_actions.v1.GitHubActionsLogsService.DumpLogs is not implemented"))
}
