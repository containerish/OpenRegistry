...
func RegisterAuthRoutes(authRouter *echo.Group, authSvc auth.Authentication) {
	...
	authRouter.Add(http.MethodDelete, "/signout", authSvc.SignOut, authSvc.JWTRest())
	authRouter.Add(http.MethodGet, "/sessions/me", authSvc.ReadUserWithSession, authSvc.JWTRest())
